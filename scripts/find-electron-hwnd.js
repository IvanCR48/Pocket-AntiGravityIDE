...
'
[ElectronFinder]::FindAllForProcess("Antigravity IDE") | ConvertTo-Json -Compress
"@
powershell -NoProfile -ExecutionPolicy Bypass -Command $psScript
`;

try {
  const out = execSync(code, { encoding: 'utf8' });
  console.log("All Electron Windows for Antigravity IDE:");
  console.log(out);
} catch (err) {
